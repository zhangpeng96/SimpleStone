<?php if ($this->allow('comment')): ?>
    ...
    <div id="comments" class="cf">
        ...
        <?php if ($comments->have()): ?>
            <span
                class="comment-num"><?php $this->commentsNum(_t('暂无评论'), _t('1 条评论'), _t('%d 条评论')); ?></span>
        ...
        <div id="<?php $this->respondId(); ?>" class="respond">
            ...
            <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
                ...
                <p style="padding-top:10px;color:#aaa;">
                    ...
                    <span id="cancel-comment-reply"><?php $comments->cancelReply('取消评论'); ?></span>
                </p>
                <div id="author_info" style="display:none;">
                    ...
                    <div id="author_info">
                        ...
                        <input type="text" name="author" maxlength="12" id="author" class="form-control"
                               placeholder="<?php _e('姓名 *'); ?>" value="<?php $this->remember('author'); ?>">
                        <input type="email" name="mail" id="mail" class="form-control"
                               placeholder="<?php _e('邮箱 *'); ?>" value="<?php $this->remember('mail'); ?>">
                        <input type="url" name="url" id="url" class="form-control" placeholder="<?php _e('网址'); ?>"
